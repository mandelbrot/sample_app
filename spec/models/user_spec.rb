...
#(*)
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated microposts" do
      ...
      #Here we have used Micropost.find_by_id, which returns nil if the record is not found, 
      #whereas Micropost.find raises an exception on failure, which is a bit harder to test for.:
      #lambda do 
